            ...
            {canDelete(u) &&
              (confirmingId === u.id ? (
                <div className="flex items-center gap-1.5">
                  ...
                  >
                    {deletingId === u.id ? "جاري الحذف…" : "تأكيد الحذف"}
                  </button>
                  <button
