...
export async function POST(req:Request){
 ...
 try{
  ...
  return NextResponse.json({reply,configured:true,provider:'openrouter',model:data?.model||model});
 }catch(error){
